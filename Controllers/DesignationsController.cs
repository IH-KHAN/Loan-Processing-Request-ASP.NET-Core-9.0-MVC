...
namespace Loan_Processing_Inzamam.Controllers
{
    ...
    public class DesignationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DesignationId,Title,IsActive")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DesignationId,Title,IsActive")] Designation designation)
        {
